...
public class MySystemTray {
    ...
    //右小角,最小化.
    //菜单项(打开)中文乱码的问题是编译器的锅,如果使用IDEA,需要在Run-Edit Configuration的VM Options中添加-Dfile.encoding=GBK
...
//        showItem.setFont(font);
        ...
        URL url = MySystemTray.class.getResource("/images/tray1.png");
